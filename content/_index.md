  ...
  - block: markdown
    content:
      ...
      text: |
        ...
        ## 🎉 News
        [08/2025] 🔥 The OES dataset will be formally released at the [Low-Altitude Sensing Forum of 2025 China Multimedia Conference](https://haiv-lab.github.io/low-altitude/)
        ...
        [02/2025] 🔥 The first version of the OES paper is available on [arXiv](https://arxiv.org/abs/2502.20668v1)
        {{< /test >}}
      design:
        spacing:
          padding: ["0px", "0px", "0px", "0px"]  # 垂直30px/水平0
