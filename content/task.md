  ...
  - block: markdown
    content:
      text: |
        ...
        If you develop your own algorithms to test on OES, please consider building upon [OpenHAIV](http://haiv-lab.github.io/openhaiv), an open-source framework that we use to perform the above tasks for open-world sensing.
        ...
        | ![random_resnet](random_resnet.jpg) | ![random_ptm](random_ptm.jpg) |
        |:-----------------:|:----------------:|
        ...
        | ![coarse_resnet](coarse_resnet.jpg) | ![coarse_ptm](coarse_ptm.jpg) |
        |:-----------------:|:----------------:|
        ...
        | ![scale_resnet](scale_resnet.jpg) | ![scale_ptm](scale_ptm.jpg) |
        |:-----------------:|:----------------:|
